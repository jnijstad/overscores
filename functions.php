...
function overscores_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'overscores' ),
	) );
 ...
 */
function overscores_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'overscores_content_width', 640 );
}
add_action( 'after_setup_theme', 'overscores_content_width', 0 );
...
function overscores_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'overscores' ),
		'id'            => 'sidebar-1',
		'description'   => '',
